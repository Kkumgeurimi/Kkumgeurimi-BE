...
class CareerAnalysisController(
    ...
    @Operation(summary = "진로버블맵 조회", description = "현재 학생의 진로 분석 결과를 반환합니다.")
    @GetMapping("/careermap")
    fun getCareerMap(): CareerBubbleMapResponse? {
        return careerAnalysisService.getCurrentStudentCareerBubbleMap()
    }
